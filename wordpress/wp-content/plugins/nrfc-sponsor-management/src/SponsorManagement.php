...
class SponsorTypeWidget extends \WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'sponsor_type_widget',
            __('Sponsors by Type', 'nrfc-sponsor-management'),
            ['description' => __('Displays a list/grid of sponsors filtered by type.', 'nrfc-sponsor-management')]
        );
    }
    ...
    public function form($instance)
    {
        ...
        $types = [
            '' => __('All types', 'nrfc-sponsor-management'),
            'club' => __('Club', 'nrfc-sponsor-management'),
            'gold' => __('Gold', 'nrfc-sponsor-management'),
            'silver' => __('Silver', 'nrfc-sponsor-management'),
            'bronze' => __('Bronze', 'nrfc-sponsor-management'),
            'associate' => __('Associate', 'nrfc-sponsor-management'),
        ];
    ...
    public function widget($args, $instance)
    {
        ...
        if ($q->have_posts()) {
            ...
            echo '<p>' . esc_html__('No sponsors found.', 'nrfc-sponsor-management') . '</p>';
        }
