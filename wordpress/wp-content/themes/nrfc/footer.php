...
<div id="cookie-banner" style="position:fixed;bottom:0;left:0;right:0;background:#222;color:#fff;padding:12px;text-align:center;z-index:9999;">
    This website uses essential cookies to ensure proper operation.
    <button onclick="document.cookie='cookie_consent=true;max-age=31536000;path=/';document.getElementById('cookie-banner').style.display='none';" style="margin-left:10px;padding:5px 12px;cursor:pointer;">OK</button>
</div>
<script>
