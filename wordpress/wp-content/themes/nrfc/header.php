<div class="header-sponsors">
	<div class="header-sponsors-container">
		<?php
		...
		if ( ! empty( $gold_sponsors ) ) {
			foreach ( $gold_sponsors as $sponsor ) {
				...
				echo '<div class="header-sponsor-item">';
				if ( ! empty( $url ) ) {
					echo '<a href="' . esc_url( $url ) . '" target="_blank" rel="noopener">';
				}

				if ( empty( $logo ) ) {
					echo '<span class="header-sponsor-name">' . esc_html( $sponsor->post_title ) . '</span>';
				} else {
					...
					echo '<img src="' . esc_url( $logo_url ) . '" alt="' . esc_attr( $sponsor->post_title ) . '" class="header-sponsor-logo">';
				}
